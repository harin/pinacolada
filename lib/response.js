...
module.exports = {
  ...
  'WAIT_LOCATION': function() {
    return _.sample([
      ...
      "Where are you now? Send me your location and I'll find a restaurant neay you."
    ])
  },
  ...
  'SUGGEST_LOOKUP': function () {
    return 'Looking up a place for you, please wait one moment.'
  },
  'SUGGEST': function (rest) {
