...
var query = function(input) {
  ...
  var wongnaiPromise = new Promise(function(resolve, reject) {
    ...
    params['categories'] = _.concat(enum.food(input.food), enum.nationality(input.nationality), enum.business(input.business));
    params['page'] = input.page;
    params['campaign'] = enum.campaign(input.campaign);
    params['features.servedAlcohol'] = enum.alcohol(input.alcohol);
    params['features.priceRanges'] = enum.price(input.price);
    params['features.parkings'] = enum.parking(input.parking);
